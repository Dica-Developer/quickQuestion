tell application "Finder"
  tell disk "QuickQuestion"
    ...
    set background picture of theViewOptions to POSIX file "/Volumes/QuickQuestion/.background/background.png"
    set position of item "Quick Question.app" of container window to {225, 40}
